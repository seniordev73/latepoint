...
<div class="row">
    <div class="col-lg-12 col-xxl-12 mb-4 order-3 order-xxl-1">
        <div class="card-header mb-4 d-flex">
            ...
            <a href="{{ url('/admin/settings/integrations-meeting') }}"
        ...
        <div class="col-md-12">
            <div class="latepoint-settings-w os-form-w">
                @if ($check == 0)
                    <form action="{{route('admin.settings-integrations-storemeeting')}}" data-os-action="settings__update"
                        method="post">
                        @csrf
                                                ...
                                                <div class="os-col-4">
                                                    <div class="os-form-group os-form-textfield-group os-form-group-simple">
                                                        <label for="settings_zoom_account_id">Account ID</label><input
                                                            ...
                                                            id="settings_zoom_account_id" class="os-form-control">
                                                    </div>
                                                </div>
                                                <div class="os-col-4">
                                                    <div class="os-form-group os-form-textfield-group os-form-group-simple">
                                                        <label for="settings_zoom_client_id">Client ID</label><input
                                                            ...
                                                            id="settings_zoom_client_id" class="os-form-control">
                                                    </div>
                                                </div>
                                                <div class="os-col-4">
                                                    <div class="os-form-group os-form-textfield-group os-form-group-simple">
                                                        <label for="settings_zoom_client_secret">Client Secret</label><input
                                                            ...
                                                            id="settings_zoom_client_secret" class="os-form-control">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="sub-section-content">
                                            <div class="latepoint-message latepoint-message-subtle">You can use variables
                                                in these templates, they will be replaced with a value for the booking. <a
                                                    href="#" class="field-note-info-link open-template-variables-panel"><i
                                            ...
                                            <div
                                                ...
                                                <label for="settings_zoom_meeting_topic_template">Template For Meeting
                                                    Topic</label><input type="text" placeholder="Template For Meeting Topic"
                                                    name="settings[zoom_meeting_topic_template]" value="@{{ service_name }}"
                                                    id="settings_zoom_meeting_topic_template" class="os-form-control">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                ...
                @else
                                <form action="{{route('admin.settings-integrations-updatemeeting', $result->id)}}"
                                    ...
                                    <div class="os-togglable-items-w">
                                        <div class="os-togglable-item-w">
                                            <div class="os-togglable-item-head">
                                                <div class="os-toggler-w">
                                                    <input type="hidden" name="settings[enable_google_meet]"
                                                        value="{{$value['enable_google_meet']}}" id="settings_enable_google_meet">
                                                    <div data-controlled-toggle-id="toggleMeetingSystemSettings_google_meet"
                                                        class="os-toggler size-large {{$value['enable_google_meet']}}"
                                                        data-is-string-value="true" data-for="settings_enable_google_meet">
                                                        <div class="toggler-rail">
                                                            <div class="toggler-pill"></div>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="os-togglable-item-body"
                                                style="<?php    echo (!empty($value['enable_google_meet']) && $value['enable_google_meet'] == "on" ? '' : 'display:none'); ?>"
                                                id="toggleMeetingSystemSettings_google_meet">
                                                <div class="sub-section-row">
                                                    <div class="sub-section-label">
                                                        <h3>API Credentials</h3>
                                        ...
                                        <div class="os-togglable-item-w">
                                            <div class="os-togglable-item-head">
                                                <div class="os-toggler-w">
                                                    <input type="hidden" name="settings[enable_zoom]"
                                                        value="{{htmlspecialchars($value['enable_zoom']) }}" id="settings_enable_zoom">
                                                    <div data-controlled-toggle-id="toggleMeetingSystemSettings_zoom"
                                                        class="os-toggler size-large {{htmlspecialchars($value['enable_zoom']) }}"
                                                        data-is-string-value="true" data-for="settings_enable_zoom">
                                                        <div class="toggler-rail">
                                                            <div class="toggler-pill"></div>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="os-togglable-item-body"
                                                style="<?php    echo (!empty($value['enable_zoom']) && $value['enable_zoom'] == "on" ? '' : 'display:none'); ?>"
                                                id="toggleMeetingSystemSettings_zoom">
                                                <div class="sub-section-row">
                                                    <div class="sub-section-label">
                                                        <h3>API Credentials</h3>
                                                            ...
                                                            <div class="os-col-4">
                                                                <div class="os-form-group os-form-textfield-group os-form-group-simple">
                                                                    <label for="settings_zoom_account_id">Account ID</label><input
                                                                        ...
                                                                        value="{{htmlspecialchars($value['zoom_account_id']) }}"
                                                                        id="settings_zoom_account_id" class="os-form-control">
                                                                </div>
                                                            </div>
                                                            <div class="os-col-4">
                                                                <div class="os-form-group os-form-textfield-group os-form-group-simple">
                                                                    <label for="settings_zoom_client_id">Client ID</label><input
                                                                        ...
                                                                        value="{{htmlspecialchars($value['zoom_client_id']) }}"
                                                                        id="settings_zoom_client_id" class="os-form-control">
                                                                </div>
                                                            </div>
                                                            <div class="os-col-4">
                                                                <div class="os-form-group os-form-textfield-group os-form-group-simple">
                                                                    <label for="settings_zoom_client_secret">Client Secret</label><input
                                                                        ...
                                                                        value="{{htmlspecialchars($value['zoom_client_secret']) }}"
                                                                        id="settings_zoom_client_secret" class="os-form-control">
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="sub-section-content">
                                                        ...
                                                        <div
                                                            ...
                                                            <label for="settings_zoom_meeting_topic_template">Template For Meeting
                                                                ...
                                                                value="{{htmlspecialchars($value['zoom_meeting_topic_template']) }}"
                                                                id="settings_zoom_meeting_topic_template" class="os-form-control">
                                                        </div>
                                                    </div>
                                                </div>
